...
public class EmployeeDBFactory {
    public static EmployeeDB createEmployeeDB(Employee employee, EmployeeDemographic employeeDemographic, EmployeeContact employeeContact, EmployeeAdress employeeAdress, EmployeeID employeeID, EmployeePosition employeePosition){
        ...
        EmployeeDB employeeDB = new EmployeeDB.Builder().setEmployee(employee).setEmployeeDemographic(employeeDemographic).setEmployeeContact(employeeContact).setEmployeeAdress(employeeAdress).setEmployeeID(employeeID).setEmployeePosition(employeePosition).build();
        return employeeDB;
    }
}
